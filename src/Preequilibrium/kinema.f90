  ...
  subroutine kinema (preeqObj, pstar, v, p, ct, st, cfi, sfi, t, cm)
...
! ======================================================================
    ...
    if (temp1 < div0Lim .and. temp1 > -div0Lim) then
       temp1 = div0Lim
       write(preeqObj%io%message,1000) "46, 49"
    ...
    if (temp < div0Lim .and. temp > -div0Lim) then
       temp = div0Lim
       write(preeqObj%io%message,1000) "61"
       call preeqObj%io%print(4, 3, preeqObj%io%message)
    end if
    ct = p(3)/temp
    temp4 = one - ct**2
    if (temp4 <= zro) then
       ...
       if (temp3 < div0Lim .and. temp3 > -div0Lim) then
          temp3 = div0Lim
          write(preeqObj%io%message,1000) "75, 76"
          call preeqObj%io%print(4, 3, preeqObj%io%message)
       end if
       cfi = p(1)/temp3
       sfi = p(2)/temp3
    ...
    return
! ======================================================================
1000 format("Divide by zero error prevented in 'kinema.f90', line ", A)
! ======================================================================
