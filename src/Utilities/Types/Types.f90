...
! Import custom types that may be used
  ...
  use, intrinsic :: iso_c_binding, only:
     ...
     logical, parameter :: f_bool = logical
     

     ! GSM Types
     integer(f_int8),       parameter :: gsm_int8
     integer(f_int16),      parameter :: gsm_int16
     integer(f_int32),      parameter :: gsm_int32
     integer(f_int64),      parameter :: gsm_int64
     real(f_float),         parameter :: gsm_float
     real(f_double),        parameter :: gsm_double
     real(f_long_double),   parameter :: gsm_long_double
